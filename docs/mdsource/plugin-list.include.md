...
* [Verify.Mockly](https://github.com/VerifyTests/Verify.Mockly): Verification of [Mockly](https://mockly.org/) bits.
...
* [Verify.OpenXml](https://github.com/VerifyTests/Verify.OpenXml/): Verification of Excel documents via  [OpenXML](https://github.com/dotnet/Open-XML-SDK/).
