...
```
<sup><a href='/src/Verify.Tests/Serialization/SerializationTests.cs#L356-L363' title='File snippet `methodwithnamedtuple` was extracted from'>snippet source</a> | <a href='#snippet-methodwithnamedtuple' title='Navigate to start of snippet `methodwithnamedtuple`'>anchor</a></sup>
<!-- endSnippet -->
...
```
<sup><a href='/src/Verify.Tests/Serialization/SerializationTests.cs#L349-L353' title='File snippet `verifytuple` was extracted from'>snippet source</a> | <a href='#snippet-verifytuple' title='Navigate to start of snippet `verifytuple`'>anchor</a></sup>
<!-- endSnippet -->
