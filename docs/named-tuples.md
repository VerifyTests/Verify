...
```
<sup>[snippet source](/src/Verify.Xunit.Tests/Tests.cs#L158-L165) / [anchor](#snippet-methodwithnamedtuple)</sup>
<!-- endsnippet -->
...
```
<sup>[snippet source](/src/Verify.Xunit.Tests/Tests.cs#L151-L155) / [anchor](#snippet-verifytuple)</sup>
<!-- endsnippet -->
