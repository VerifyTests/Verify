...
```
<sup><a href='/src/Verify.Tests/Serialization/SerializationTests.cs#L64-L68' title='File snippet `scrublines` was extracted from'>snippet source</a> | <a href='#snippet-scrublines' title='Navigate to start of snippet `scrublines`'>anchor</a></sup>
<!-- endsnippet -->
...
```
<sup><a href='/src/Verify.Tests/Serialization/SerializationTests.cs#L70-L74' title='File snippet `scrublinescontaining` was extracted from'>snippet source</a> | <a href='#snippet-scrublinescontaining' title='Navigate to start of snippet `scrublinescontaining`'>anchor</a></sup>
<!-- endsnippet -->
...
```
<sup><a href='/src/Verify.Tests/Serialization/SerializationTests.cs#L76-L80' title='File snippet `scrublinescontainingordinal` was extracted from'>snippet source</a> | <a href='#snippet-scrublinescontainingordinal' title='Navigate to start of snippet `scrublinescontainingordinal`'>anchor</a></sup>
<!-- endsnippet -->
...
```
<sup><a href='/src/Verify.Tests/Serialization/SerializationTests.cs#L82-L86' title='File snippet `scrublineswithreplace` was extracted from'>snippet source</a> | <a href='#snippet-scrublineswithreplace' title='Navigate to start of snippet `scrublineswithreplace`'>anchor</a></sup>
<!-- endsnippet -->
...
```
<sup><a href='/src/Verify.Tests/Serialization/SerializationTests.cs#L88-L92' title='File snippet `scrubmachinename` was extracted from'>snippet source</a> | <a href='#snippet-scrubmachinename' title='Navigate to start of snippet `scrubmachinename`'>anchor</a></sup>
<!-- endsnippet -->
