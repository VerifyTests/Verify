...
await Verify(target);
```
<sup><a href='/src/Verify.Tests/Tests.cs#L739-L755' title='File snippet `date` was extracted from'>snippet source</a> | <a href='#snippet-date' title='Navigate to start of snippet `date`'>anchor</a></sup>
<!-- endsnippet -->
