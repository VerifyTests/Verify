...
public Task VerifyFileWithInfo() =>
    VerifyFile(
        ...
        info: "the info");
```
<sup><a href='/src/Verify.Tests/StreamTests.cs#L167-L175' title='Snippet source file'>snippet source</a> | <a href='#snippet-verifyfilewithinfo' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
