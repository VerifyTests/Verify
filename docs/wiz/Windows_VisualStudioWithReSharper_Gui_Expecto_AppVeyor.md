...
Source File: /docs/mdsource/wiz/Windows_VisualStudioWithReSharper_Gui_Expecto_AppVeyor.source.md
...
<PackageReference Include="Verify.Expecto" Version="22.7.0" />
```
...
```
<sup><a href='/src/appveyor.yml#L54-L57' title='Snippet source file'>snippet source</a> | <a href='#snippet-appveyorartifacts' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
