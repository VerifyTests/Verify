...
[![TestMu](https://raw.githubusercontent.com/VerifyTests/Verify/main/docs/TestMu.png)](https://www.testmuai.com/?utm_medium=sponsor&utm_source=verify)<!-- endInclude -->
...
```
<sup><a href='/src/Verify.Tests/JsonTests.cs#L198-L223' title='Snippet source file'>snippet source</a> | <a href='#snippet-VerifyJson' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
