...
public partial class VerifyBase
{
    ...
    internal static PathInfo GetPathInfo(string sourceFile, string typeName, MethodInfo method) =>
        derivePathInfo(sourceFile, TargetAssembly.ProjectDir, typeName, method);
