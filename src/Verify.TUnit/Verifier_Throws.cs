...
public static partial class Verifier
{
    ...
    public static SettingsTask Throws(
        ...
        Verify(settings, sourceFile, lineNumber, _ => _.Throws(target));
    ...
    public static SettingsTask ThrowsTask(
        ...
        [CallerFilePath] string sourceFile = "",
        [CallerLineNumber] int lineNumber = 0) =>
        Verify(settings, sourceFile, lineNumber, _ => _.ThrowsTask(target));
    ...
    public static SettingsTask ThrowsValueTask(
        ...
        [CallerFilePath] string sourceFile = "",
        [CallerLineNumber] int lineNumber = 0) =>
        Verify(settings, sourceFile, lineNumber, _ => _.ThrowsValueTask(target));
