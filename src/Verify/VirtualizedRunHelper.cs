class VirtualizedRunHelper
{
    ...
    {
        var prefix = path1.TrimEnd(separators);
        var suffix = path2.Replace(OtherDirectorySeparatorChar, Env.DirectorySeparatorChar);
        return $"{prefix}{Env.DirectorySeparatorChar}{suffix}";
    }
